                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control" name="language" id="language">
                                    <option value="pt-BR" {{ old('language') == "pt-BR" ? 'selected' : '' }}>Português</option>
                                    <option value="es-ES" {{ old('language') == "es-ES" ? 'selected' : '' }}>Espanhol</option>
                                    <option value="en-US" {{ old('language') == "en-US" ? 'selected' : '' }}>Inglês</option>
                                </select>
                                @error('language')
                                <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                                @enderror
