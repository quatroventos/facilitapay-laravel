...
@section('content')
    <nav class="navbar navbar-main navbar-expand-lg  px-0 mx-4 shadow-none border-radius-xl z-index-sticky " id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            @include('backend.layouts.navbars.auth.topnav', ['title' => 'Editar FAQ'])
        ...
        <div class="row">
            <div class="col-lg-9 col-12 mx-auto">
                <div class="card card-body mt-4">
                    <h6 class="mb-0">Cadastrar FAQ</h6>
                    <hr class="horizontal dark my-3">
                    <form method="POST" action="{{ route('faq-edit.update', $faq->id) }}" enctype="multipart/form-data"
                          class="course-form">
                        @csrf
                        ...
                        <label class="mt-4">Resposta</label>
                        <div class="">
                            <div data-toggle="quill" id="editor" class="editor-description"
                                 data-quill-placeholder="Resposta">
        ...
        $(document).ready(function() {
            $(".course-form").on("submit", function(e) {
                ...
                if (quillEditor.getLength() > 1) {
                    $(this).append("<textarea name='answer' style='display:none'>" + editorvalue +
                        "</textarea>");
                }
            });
        });
