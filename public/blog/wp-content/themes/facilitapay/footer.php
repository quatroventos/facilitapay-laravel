    ...
    <div class="container d-flex flex-column gap-3 pb-4 pt-4">
        <div class="row align-items-center">
            <div class="col-7 col-lg-2">
                <a href="index">
                    <img src="https://facilitapay.com/img/logo-facilitapay-negative.svg" class="h-4 img-fluid">
                </a>
            </div>
                    ...
                    <ul class="align-center justify-content-end d-flex flex-row column-gap-1 sub">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="submenu">
                                <ul>
                                    <li>
                                        <a href="/industries" class="justify-center d-inline-flex gap-1"><img src="https://facilitapay.com/img/ico-industries.svg" class="h-1"> <span class="d-inline-flex align-items-center">Industries</span></a>
                                    </li>
                                    <li>
                                        <a href="/markets-brazil" class="justify-center d-inline-flex gap-1"><img src="https://facilitapay.com/img/ico-brazil.svg" class="h-1"> <span class="d-inline-flex align-items-center">Brazil</span></a>
                                    </li>
                                    <li>
                                        <a href="/markets-colombia" class="justify-center d-inline-flex gap-1"><img src="https://facilitapay.com/img/ico-colombia.svg" class="h-1"> <span class="d-inline-flex align-items-center">Colombia</span></a>
                                    </li>
                                    <li>
                                        <a href="/markets-mexico" class="justify-center d-inline-flex gap-1"><img src="https://facilitapay.com/img/ico-mexico.svg" class="h-1"> <span class="d-inline-flex align-items-center">Mexico</span></a>
                                    </li>
                                </ul>
                            </div>
                        </li>
        ...
        <div class="row d-flex row-gap-2">
            <div class="col-12 col-md-6 col-lg-3">
                <img src="https://facilitapay.com/img/ico-usa.svg" class="h-2">
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <img src="https://facilitapay.com/img/ico-brazil.svg" class="h-2">
                <div class="d-flex flex-column gap-1">
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <img src="https://facilitapay.com/img/ico-mexico.svg" class="h-2">
                <div class="d-flex flex-column gap-1">
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <img src="https://facilitapay.com/img/ico-colombia.svg" class="h-2">
                <div class="d-flex flex-column gap-1">
        ...
        <div class="row d-flex row-gap-3">
            <div class="col d-flex gap-2 align-items-center">
                <img src="https://facilitapay.com/img/logo-scaleup.png" class="h-3 ignoreanimation">
                <img src="https://facilitapay.com/img/logo-endeavor.png" class="h-3 ignoreanimation">
            </div>
...
<script src="https://facilitapay.comjs/imageMapResizer.min.js"></script>
