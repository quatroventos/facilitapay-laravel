...
<head>
    ...
    <meta name="title" content="FacilitaPay">
    <meta name="description" content="The payment platform designed for the growth and scale of your business. One simple integration, multiple countries.">

    <meta property="og:title" content="FacilitaPay">
    <meta property="og:site_name" content="FacilitaPay">
    <meta property="og:url" content="https://www.facilitapay.com">
    <meta property="og:description" content="The payment platform designed for the growth and scale of your business. One simple integration, multiple countries.">
    <meta property="og:image" content="https://facilitapay.com/img/blocks.jpg">
    ...
    <div class="container pb-1 pt-1">
        <div class="row align-items-center justify-content-center">
            <div class="col-7 col-sm-3">
                <a href="index"><img src="img/logo-facilitapay.svg" class="h-4 ignoreanimation"></a>
            </div>
            ...
            <div class="col-12 col-sm-4">
                <ul class="align-center d-flex flex-row gap-1">
                    <li>
                        <a href="optin" target="_blank" class="btn d-inline-flex"><strong>Contact Us</strong></a>
                    </li>
                </ul>
            </div>
        </div>
...
<section class="">
          <div class="container d-flex flex-column gap-2 text-center pt-4">
            ...
            <div class="row justify-content-center">
              <div class="col justify-content-center d-flex">
                <a href="#optin" class="btn"><strong>Contact Us</strong></a>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="container gap-24 text-center">
            <div class="row justify-content-center">
              <div class="col-12 col-lg-10 gap-12">
                  <img src="img/dashboard.jpg" class="img-fluid ignoreanimation" id="dash">
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="container d-flex flex-column gap-2 pt-4">
            <div class="row align-items-center justify-content-center">
              ...
              <div class="col-12 col-sm-6 col-lg-5 d-flex flex-column gap-2">
                ...
                <a href="#optin" class="btn btn-big me-auto"><strong>Contact Us</strong></a>
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="hero-7">
          <div class="container d-flex flex-column gap-3 pb-5 pt-5">
            ...
            <div class="row d-flex justify-content-center text-center">
              <div class="col-8">
                <a href="#optin" class="btn btn-6 d-inline-flex"><strong>Contact Us</strong></a>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="container">
            <div class="row">
              <div class="col-12 d-flex flex-column gap-2">
                ...
                <a href="#optin"  target="_blank" class="btn me-auto"><strong>Contact Us</strong></a>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="container">
            <div class="row">
              <div class="col-12 col-lg-4">
                <div class="d-flex flex-column gap-1">
                  <div><img src="img/icos/ico-13.svg" class="stepico"></div>
                  <h6>Step 1</h6>
              ...
              <div class="col-12 col-lg-4">
                <div class="d-flex flex-column gap-1">
                  <div><img src="img/icos/ico-14.svg" class="stepico"></div>
                  <h6>Step 2</h6>
              ...
              <div class="col-12 col-lg-4">
                <div class="d-flex flex-column gap-1">
                  <div><img src="img/icos/ico-15.svg" class="stepico"></div>
                  <h6>Step 3</h6>
        ...
        <section class="steps">
          <div class="container">
            <div class="row">
              <div class="col-12 col-lg-4">
                <div class="d-flex flex-column gap-1">
                  <div><img src="img/icos/ico-16.svg" class="stepico"></div>
                  <h6>Step 4</h6>
                  <h5>Integration.</h5>
                </div>
              </div>
              <div class="col-12 col-lg-4">
                <div class="d-flex flex-column gap-1">
                  <div><img src="img/icos/ico-17.svg" class="stepico"></div>
                  <h6>Step 5</h6>
              ...
              <div class="col-12 col-lg-4">
                <div class="d-flex flex-column gap-1">
                  <div><img src="img/icos/ico-18.svg" class="stepico"></div>
                  <h6>Step 6</h6>
        ...
        <section class="content-8">
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-11 col-lg-10" style="background-image: url('img/locations.jpg');" id="location">
                  ...
                  <div class="row justify-content-center">
                    <div class="col-12 col-sm-8 d-flex flex-column text-center justify-content-center">
                       <div class="d-flex flex-column gap-2 text-center justify-content-center">
                        ...
                        <a href="#optin" class="btn m-auto"><strong>Contact Us</strong></a>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div class="container d-flex flex-column gap-3 pb-4 pt-4">
        <div class="row align-items-center">
            <div class="col-7 col-lg-2">
                <a href="index">
                    <img src="img/logo-facilitapay-negative.svg" class="h-4">
                </a>
            </div>
            <div class="col-5 col-lg-10 d-flex align-items-center">
                <div class="menu open-2 responsive">
                    <a href="#!" class="toggle toggle-2 d-flex d-sm-none"><span>Toggle menu</span></a>
        ...
        <div class="row d-flex row-gap-2">
            <div class="col-12 col-lg-3">
                <img src="img/ico-usa.svg">
                <div class="d-flex flex-column gap-1">
                    <h5>FACILITAPAY US LLC</h5>
                    <p class="sub">201 S. Biscayne Blvd, Suite 1200, Miami, FL 33131, United States.</p>
                </div>
            </div>
            <div class="col-12 col-lg-3">
                <img src="img/ico-brazil.svg">
                <div class="d-flex flex-column gap-1">
                    <h5 style="text-transform: uppercase;">Facilita Instituição de Pagamento S/A</h5>
                    <p class="sub">Rua Senador Milton Campos, n. 35 - Vila da Serra CEP 34006-050 - Nova Lima, MG, Brazil.</p>
                </div>
            </div>
            <div class="col-12 col-lg-3">
                <img src="img/ico-mexico.svg">
                <div class="d-flex flex-column gap-1">
                    <h5>FPAY INTERNACIONAL, SA</h5>
                    <p class="sub">Boulevard Manuel Ávila Camacho 118, 16 floor Ciudad de México, 11000, México.</p>
                </div>
            </div>
            <div class="col-12 col-lg-3">
                <img src="img/ico-colombia.svg">
                <div class="d-flex flex-column gap-1">
                    <h5 style="text-transform: uppercase;">FPay Colombia S.A.S.</h5>
