<?php include('inc/header.php'); ?>
        ...
        <section class="hero-6" style="background-image: url('img/woman-laptop.jpg');">
          ...
          <div class="container pb-4 pt-4">
            <div class="row row-gap-3 justify-content-center">
              <div class="col-12 col-lg-6 d-flex flex-column gap-2">
                <div class="img" style="background-image: url('img/industries/investments.png');"></div>
                ...
                <div class="d-flex gap-2">
                  <img src="img/logos/sproutfi.png" class="h-1">
                  <img src="img/logos/stake.png" class="h-1">
                  <img src="img/logos/tickmill.png" class="h-1">
                  <img src="img/logos/easymarkets.png" class="h-1">
                </div>
          ...
          <div class="container pb-4 pt-4">
            <div class="row row-gap-3 justify-content-center flex-column-reverse flex-lg-row">
              ...
              <div class="col-12 col-lg-6 d-flex flex-column gap-2">
                ...
                <div class="d-flex gap-2">
<!--                  <img src="img/logos/texcent.png" alt="texcent" class="h-1">-->
                  <img src="img/logos/flutterwave.png" class="h-1">
                  <img src="img/logos/boku.png" class="h-1">
                  <img src="img/logos/wyre.png" class="h-1">
                </div>
                <a href="optin.php" class="btn me-auto"><strong>Start Now</strong></a>
              </div>
            </div>
        ...
        <section class="content-9 bg-light-gray" id="crypto">
          <div class="container pb-4 pt-4">
            <div class="row row-gap-3 justify-content-center">
              <div class="col-12 col-lg-6 d-flex flex-column gap-2">
                <div class="img" style="background-image: url('img/industries/crypto.png');"></div>
                ...
                <div class="d-flex gap-2">
                  <img src="img/logos/bybit-blue.png" class="h-1">
                  <img src="img/logos/bitso-blue.png" class="h-1">
                  <img src="img/logos/kraken.png" class="h-1">
                  <img src="img/logos/okx-blue.png" class="h-1">
                </div>
                <a href="optin.php" class="btn me-auto"><strong>Start Now</strong></a>
              </div>
              <div class="col-12 col-lg-4 d-flex flex-column gap-1">
        ...
        <section class="content-9 bg-white" id="gaming">
          <div class="container pb-4 pt-4">
            <div class="row row-gap-3 justify-content-center flex-column-reverse flex-lg-row">
              ...
              <div class="col-12 col-lg-6 d-flex flex-column gap-2">
                <div class="img" style="background-image: url('img/industries/gaming.png');"></div>
                ...
                <div class="d-flex gap-2">
<!--                  <img src="img/logos-ex/logo-1.svg" class="h-1">-->
<!--                  <img src="img/logos-ex/logo-2.svg" class="h-1">-->
<!--                  <img src="img/logos-ex/logo-3.svg" class="h-1">-->
<!--                  <img src="img/logos-ex/logo-4.svg" class="h-1">-->
                </div>
                <a href="optin.php" class="btn me-auto"><strong>Start Now</strong></a>
              </div>
            </div>
        ...
        <section class="content-9 bg-light-gray" id="remittance">
          <div class="container pb-4 pt-4">
            <div class="row row-gap-3 justify-content-center">
              <div class="col-12 col-lg-6 d-flex flex-column gap-2">
                <div class="img" style="background-image: url('img/industries/remitance.png');"></div>
                ...
                <div class="d-flex gap-2">
                  <img src="img/logos/belmoney.png" class="h-1">
                  <img src="img/logos/global66.png" class="h-1">
                  <img src="img/logos/wyre.png" class="h-1">
                  <img src="img/logos/tempofrance.png" class="h-2">
                </div>
                <a href="optin.php" class="btn me-auto"><strong>Start Now</strong></a>
              </div>
              <div class="col-12 col-lg-4 d-flex flex-column gap-1">
        ...
        <section class="content-9 bg-white" id="saas">
          <div class="container pb-4 pt-4">
            <div class="row row-gap-3 justify-content-center flex-column-reverse flex-lg-row">
              ...
              <div class="col-12 col-lg-6 d-flex flex-column gap-2">
                <div class="img" style="background-image: url('img/industries/saas.png');"></div>
                ...
                <div class="d-flex gap-2">
                  <img src="img/logos/floori.png" class="h-1">
<!--                  <img src="img/logos-ex/logo-2.svg" class="h-1">-->
<!--                  <img src="img/logos-ex/logo-3.svg" class="h-1">-->
<!--                  <img src="img/logos-ex/logo-4.svg" class="h-1">-->
                </div>
        ...
        <section class="content-9 bg-light-gray" id="streaming">
          <div class="container pb-4 pt-4">
            <div class="row row-gap-3 justify-content-center">
              <div class="col-12 col-lg-6 d-flex flex-column gap-2">
                <div class="img" style="background-image: url('img/industries/streaming.png');"></div>
        ...
        <section class="content-9 bg-white" id="ecommerce">
          <div class="container pb-4 pt-4">
            <div class="row row-gap-3 justify-content-center flex-column-reverse flex-lg-row">
              ...
              <div class="col-12 col-lg-6 d-flex flex-column gap-2">
                <div class="img" style="background-image: url('img/industries/ecommerce.png');"></div>
                ...
                <div class="d-flex gap-2">
                  <img src="img/logos/octoshop.png" class="h-1">
<!--                  <img src="img/logos-ex/logo-2.svg" class="h-1">-->
<!--                  <img src="img/logos-ex/logo-3.svg" class="h-1">-->
<!--                  <img src="img/logos-ex/logo-4.svg" class="h-1">-->
                </div>
