            ...
            <div class="row justify-content-center">
              <div class="col-12 col-lg-5 d-flex flex-column gap-2">
                <div class="d-flex flex-column gap-1">
                  ...
                  <h3 class="txt-white"><strong>Master <strong class="txt-light-green">local payment collection</strong> in emerging markets</strong></h3>
                </div>
                <p class="txt-white">Boost payment conversion rate and reach by offering your users a payment experience they choose daily.</p>
          ...
          <div class="container text-start pb-4 pt-4">
            <div class="row row-gap-2 flex-column-reverse flex-md-row align-items-center justify-content-center">
              <div class="col-12 col-md-6 col-lg-4 d-flex flex-column gap-2">
                <h4><strong>Deliver a <strong class="txt-light-green">local payment experience</strong> and leverage the best features to boots conversion rates</strong></h4>
                <ul class="d-flex flex-column gap-1">
                  <li class="d-flex align-items-center gap-1">
                    <img src="/static/img/ico-check-2.svg" class="h-1">
                    <span>Local Credit/Debit cards</span>
                  </li>
                  <li class="d-flex align-items-center gap-1">
                    <img src="/static/img/ico-check-2.svg" class="h-1">
                  ...
                  <li class="d-flex align-items-center gap-1">
                    <img src="/static/img/ico-check-2.svg" class="h-1">
                    <span>Local alternative payment methods</span>
                  </li>
                  <li class="d-flex align-items-center gap-1">
                    <img src="/static/img/ico-check-2.svg" class="h-1">
        ...
        <section class="content-1 bg-white">
          <div class="container text-start pb-4">
            <div class="row row-gap-2 align-items-center justify-content-center">
              ...
              <div class="col-12 col-md-6 col-lg-4 d-flex flex-column gap-2">
                <h4><strong>Reach more than <strong class="txt-light-green">95% consumers in emerging markets</strong>, by accepting the payment methods in which they rely on every day</strong></h4>
                <ul class="d-flex flex-column gap-1">
                  <li class="d-flex align-items-center gap-1">
                    <img src="/static/img/ico-check-2.svg" class="h-1">
                    <span>Increase approval rates</span>
                  </li>
                  <li class="d-flex align-items-center gap-1">
                    <img src="/static/img/ico-check-2.svg" class="h-1">
                    <span>Prevent chargebacks</span>
                  </li>
                  <li class="d-flex align-items-center gap-1">
                    <img src="/static/img/ico-check-2.svg" class="h-1">
                    <span>Connect directly to local payment rails</span>
                  </li>
                  <li class="d-flex align-items-center gap-1">
                    <img src="/static/img/ico-check-2.svg" class="h-1">
                    <span>Deliver a faster and low cost experience to your end users</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-12 col-md-4">
                <div class="d-flex flex-column gap-1">
                  ...
                  <h6>Step 1</h6>
                  <h5>A multi-currency account within FacilitaPay is created for the merchant</h5>
                </div>
              </div>
              <div class="col-12 col-md-4">
                <div class="d-flex flex-column gap-1">
                  ...
                  <h6>Step 2</h6>
                  <h5>End user instructs a payout directly on merchant's page/app</h5>
                </div>
              </div>
              <div class="col-12 col-md-4">
                <div class="d-flex flex-column gap-1">
                  ...
                  <h6>Step 3</h6>
                  <h5>FacilitaPay API acts in the back-end of the merchant's banking system</h5>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-12 col-md-4">
                <div class="d-flex flex-column gap-1">
                  ...
                  <h6>Step 4</h6>
                  <h5>FacilitaPay receives the payout instruction</h5>
                </div>
              </div>
              <div class="col-12 col-md-4">
                <div class="d-flex flex-column gap-1">
                  ...
                  <h6>Step 5</h6>
                  <h5>FacilitaPay convert the funds between internal accounts</h5>
                </div>
              </div>
              <div class="col-12 col-md-4">
                <div class="d-flex flex-column gap-1">
                  ...
                  <h6>Step 6</h6>
                  <h5>They payout is processed by FacilitaPay payment network</h5>
                </div>
              </div>
            </div>
          </div>
...
<!--          <div class="container pb-4 pt-4">-->
<!--            <div class="row justify-content-center">-->
<!--              <div class="col-12 col-lg-5 d-flex align-items-center bg-light-green">-->
<!--                <div class="square"></div>-->
<!--                <div class="p-2">-->
<!--                  <h3><strong>The future of payments in the metaverse.</strong></h3>-->
<!--                </div>-->
<!--              </div>-->
<!--              <div class="col-12 col-lg-5 bg-blue txt-white" style="background-image: url('img/bg-cta.jpg');">-->
<!--                <div class="d-flex flex-column gap-1 p-2">-->
<!--                  <h4 class="txt-white">From blockchain to digital payments.</h4>-->
